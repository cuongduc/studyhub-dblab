...
--
-- Host: localhost
-- Generation Time: May 27, 2014 at 01:53 AM
...
CREATE TABLE IF NOT EXISTS `sm_courses` (
  ...
  KEY `cat_id` (`cat_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Courses that are currently available in the system' AUTO_INCREMENT=33 ;
...
(1, 32, 'IT4362', 'Database Lab', 'dbexp', '2', 'rat hay', '2014-05-20 00:00:00', 20, 'images/courses/css-thumbnail.png', '', '');
...
CREATE TABLE IF NOT EXISTS `sm_course_cat` (
  ...
  PRIMARY KEY (`cat_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Course catagories' AUTO_INCREMENT=14 ;
...
(25, 19, 5, 2, 'B', '', 1, 1400552936, 3, 20, 'Y'),
(25, 19, 5, 2, 'C', '', 2, 1400553097, 4, NULL, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Store user''s credentials, used to login, create new user' AUTO_INCREMENT=27 ;
...
(24, 'worm', '$2y$12$458449870537ab61b5752esGMdu1cY5p1qVGxHwbX6tCbcoepl1N2', '2', 'worm@example.com', 'Funny Teacher', NULL, '2014-05-20 01:55:40', 'Worm', 'Teacher', 'Male', 'Fake teacher user', 'code_537ab61b522a80.59574589', 'images/avatars/worm.png', 1400550939, 1, '0', '::1'),
(25, 'tienla', '$2y$12$566088327537abc9c2559urS4MT1AyVdeUfsSD7T3NpdqG5t7fL2i', '1', 'tienla@nka.vom', 'tienla', NULL, '2014-05-20 02:23:25', 'tien', 'le', 'Male', 'raats dep zai', 'code_537abc9c255245.47972992', 'images/avatars/tienla.png', 1400552604, 1, '0', '::1'),
(26, 'vttrinh', '$2y$12$968435760537ac75c2725eQfqyb76AuaOi/xqHKaSi4zUCahBv1s6', '2', 'vttrinh2@gmail.com', 'Vu Tuyet Trinh', NULL, '2014-05-20 03:09:17', 'VU Tuyet', 'Trinh', 'Female', 'GV', 'code_537ac75c1365d7.66183484', 'images/avatars/vttrinh.png', 1400555356, 1, '0', '::1');
